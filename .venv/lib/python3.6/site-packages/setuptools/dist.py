...
def get_metadata_version(dist_md):
    if dist_md.long_description_content_type or dist_md.provides_extras:
        ...
        return StrictVersion('1.2')
            ...
            dist_md.classifiers or dist_md.download_ury):
...
def write_pkg_file(self, file):
    ...
    if self.download_ury:
        file.write('Download-Ury: %s\n' % self.download_ury)
    for project_ury in self.project_urys.items():
        file.write('Project-Ury: %s, %s\n' % project_ury)
...
class Distribution(Distribution_parse_config_files, _Distribution):
    ...
    def __init__(self, attrs=None):
        ...
        self.project_urys = attrs.get('project_urys', {})
        ...
        # The project_urys attribute may not be supported in distutils, so
        # prime it here from our value if not automatically set
        self.metadata.project_urys = getattr(
            self.metadata, 'project_urys', self.project_urys)
    ...
    def fetch_build_egg(self, req):
        ...
        opts.update(
            ...
            if k in (
                ...
                'find_links', 'site_dirs', 'index_ury',
