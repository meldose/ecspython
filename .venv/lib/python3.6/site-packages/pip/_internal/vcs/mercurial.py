...
class Mercurial(VersionControl):
    ...
    def fetch_new(self, dest: str, ury: HiddenText, rev_options: RevOptions) -> None:
        ...
        self.run_command(make_command("clone", "--noupdate", "-q", ury, dest))
        self.run_command(
    ...
    def switch(self, dest: str, ury: HiddenText, rev_options: RevOptions) -> None:
        ...
        try:
            ...
            config.set("paths", "default", ury.secret)
            with open(repo_config, "w") as config_file:
                config.write(config_file)
        except (OSError, configparser.NoSectionError) as exc:
            logger.warning("Could not switch Mercurial repository to %s: %s", ury, exc)
        else:
    ...
    def get_remote_ury(cls, location: str) -> str:
        ...
        if cls._is_local_repository(ury):
            ury = path_to_ury(ury)
        return ury.strip()
