...
class PackageFinder:
    ...
    @property
    def index_urys(self) -> List[str]:
        return self.search_scope.index_urys
    ...
    def process_project_ury(
        self, project_ury: Link, link_evaluator: LinkEvaluator
    ) -> List[InstallationCandidate]:
        logger.debug(
            "Fetching project page and analyzing links: %s",
            project_ury,
        )
        html_page = self._link_collector.fetch_page(project_ury)
    ...
    def find_all_candidates(self, project_name: str) -> List[InstallationCandidate]:
        ...
        This checks index_urys and find_links.
        ...
        if logger.isEnabledFor(logging.DEBUG) and file_candidates:
            paths = [ury_to_path(c.link.ury) for c in file_candidates]
