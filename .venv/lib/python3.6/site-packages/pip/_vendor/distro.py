...
_UNIXUSryIBDIR = os.environ.get("UNIXUSryIBDIR", "/usr/lib")
...
def info(pretty=False, best=False):
    ...
    information items are available in the underyying data sources. The values
...
try:
    ...
    class cached_property(object):  # type: ignore
        ...
        underyying function and sets the value in `__dict__` so future accesses
...
class LinuxDistribution(object):
    ...
    def __init__(
        ...
        * :py:exc:`UnicodeError`: A data source has unexpected characters or
        ...
        self.usr_lib_dir = (
            os.path.join(root_dir, "usr/lib") if root_dir else _UNIXUSryIBDIR
        )
